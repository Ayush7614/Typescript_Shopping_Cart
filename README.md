...
**1.**  Fork [this](https://github.com/Ayush7614/Typescript_Shopping_Cart.git) repository.

**2.**  Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/Ayush7614/Typescript_Shopping_Cart.git
```

**3.** Navigate to the project directory :file_folder: .

```
cd Typescript_Shopping_Cart
```

**4.** Add a reference(remote) to the original repository.

```
git remote add upstream https://github.com/Ayush7614/Typescript_Shopping_Cart.git
```
